...
public class KafkaConsumerConfig {
	...
	/*
	 * @Value(value = "${general.topic.group.id}") private String groupId;
	 */

	@Value(value = "${stud.topic.group-id}")
	 ...
	 * StringDeserializer.class); props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
	...
	public ConsumerFactory<String, String> empConsumerFactory() {
		Map<String, Object> props = new HashMap<>();
		props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
